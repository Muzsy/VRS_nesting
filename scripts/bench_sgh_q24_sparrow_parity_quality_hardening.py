#!/usr/bin/env python3
"""SGH-Q24 Sparrow parity quality hardening benchmark — LV8 ladder.
...
STEM = "sgh_q24_sparrow_parity_quality_hardening_measurements"
...
def emit_md(rows, acct):
    L = ["# SGH-Q24 Sparrow parity quality hardening — LV8 ladder measurements\n",
