#!/usr/bin/env python3
"""SGH-Q23R1 production Sparrow cutover benchmark.
...
STEM = "sgh_q23r1_production_sparrow_cutover_measurements"
...
def emit_md(results: dict) -> str:
    L = []
    L.append("# SGH-Q23R1 production Sparrow cutover — benchmark measurements\n")
    ...
    for row in results["rows"]:
        ...
        L.append(
            ...
            f"{render_value(m.get('cde_cache_pair_hits'))}/{render_value(m.get('cde_cache_pair_misses'))} | "
