#!/usr/bin/env python3
"""SGH-Q23 full Sparrow parity cutover benchmark.
...
STEM = "sgh_q23_full_sparrow_parity_cutover_measurements"
...
def emit_md(results: dict) -> str:
    L = []
    L.append("# SGH-Q23 full Sparrow parity cutover — benchmark measurements\n")
    ...
    for row in results["rows"]:
        ...
        L.append(
            ...
            f"{render_value(m.get('cde_broadphase_pruned'))} | {render_value(m.get('bbox_fallback_queries'))} | "
