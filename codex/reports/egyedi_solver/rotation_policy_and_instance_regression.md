...
| Validator gate a standard check resze | PASS | `scripts/check.sh:127`; `scripts/validate_nesting_solution.py:42` | A check gate futtatja a validator scriptet a solver run kimeneten. | `./scripts/verify.sh --report codex/reports/egyedi_solver/rotation_policy_and_instance_regression.md` |
