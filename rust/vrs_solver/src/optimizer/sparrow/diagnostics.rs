...
pub struct SparrowDiagnostics {
    ...
    pub feature_candidates_generated: usize,
    pub feature_candidates_accepted: usize,
    pub bbox_corner_candidates_generated: usize,
    pub bbox_corner_candidates_accepted: usize,
    pub accepted_feature_pair_type: Option<String>,
    pub feature_refine_seed_rotation_deg: Option<f64>,
    pub feature_refine_refined_rotation_deg: Option<f64>,
    pub feature_refine_iterations: usize,
    pub feature_refine_successes: usize,
    pub feature_refine_failures: usize,
    pub feature_refine_rejection_reason: Option<String>,
    // ── worker competition ──────────────────────────────────────────────────
    pub worker_count: usize,
...
impl Default for SparrowDiagnostics {
    fn default() -> Self {
        ...
        Self {
            ...
            lbf_fallback_used: 0,
            feature_candidates_generated: 0,
            feature_candidates_accepted: 0,
            bbox_corner_candidates_generated: 0,
            bbox_corner_candidates_accepted: 0,
            accepted_feature_pair_type: None,
            feature_refine_seed_rotation_deg: None,
            feature_refine_refined_rotation_deg: None,
            feature_refine_iterations: 0,
            feature_refine_successes: 0,
            feature_refine_failures: 0,
            feature_refine_rejection_reason: None,
            worker_count: 0,
            worker_passes: 0,
            ...
            spacing_offset_build_ms: 0.0,
            spacing_offset_input_vertex_total: 0,
            spacing_offset_output_vertex_total: 0,
            spacing_offset_area_ratio_sum: 0.0,
            spacing_offset_area_ratio_max: 0.0,
            spacing_offset_max_ms_per_part: 0.0,
