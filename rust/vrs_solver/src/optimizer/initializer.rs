...
pub fn build_initial_layout_with_rotation_context(
    ...
    for instance in ordered {
        ...
        // Instance.allowed_rotations_deg is already resolved (Vec<f64>) from expand_instances.
        let allowed_rotations = instance.allowed_rotations_deg.as_slice();
